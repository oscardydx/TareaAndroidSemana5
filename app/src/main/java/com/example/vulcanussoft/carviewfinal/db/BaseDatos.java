...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public ArrayList<Mascota> mascotasConMayorLikes(){

        ArrayList<Mascota> mascotas= new ArrayList<>();

        Mascota m1=new Mascota(0);
        Mascota m2=new Mascota(0);
        Mascota m3=new Mascota(0);
        Mascota m4=new Mascota(0);
        Mascota m5=new Mascota(0);
        ...
        while(registros.moveToNext()){
            ...
            if (masccotaActual.getLike()!=0){
                if (masccotaActual.getLike()>m1.getLike()){
                    m5=m4;m4=m3;m3=m2;m2=m1;m1=masccotaActual;}else if ( masccotaActual.getLike()==m1.getLike()){
                    m5=m4;m4=m3;m3=m2;m2=masccotaActual;}else if (masccotaActual.getLike()>m2.getLike()){
                    m5=m4;m4=m3;m3=m2;m2=masccotaActual;}else if ( masccotaActual.getLike()==m2.getLike()){
                    m5=m4;m4=m3;m3=masccotaActual;}else if (masccotaActual.getLike()>m3.getLike()){
                    m5=m4;m4=m3;m3=masccotaActual;}else if ( masccotaActual.getLike()==m3.getLike()){
                    m5=m4;m4=masccotaActual;}else if (masccotaActual.getLike()>m4.getLike()){
                    m5=m4;m4=masccotaActual;}else if ( masccotaActual.getLike()==m4.getLike()){
                    m5=masccotaActual;}else if (masccotaActual.getLike()>m5.getLike()){
                    m5=masccotaActual;}         }
        ...
        db.close();
        if(m1.getLike()!=0){mascotas.add(m1);}
        if(m2.getLike()!=0){mascotas.add(m2);}
        if(m3.getLike()!=0){mascotas.add(m3);}
        if(m4.getLike()!=0){mascotas.add(m4);}
        if(m5.getLike()!=0){mascotas.add(m5);}
